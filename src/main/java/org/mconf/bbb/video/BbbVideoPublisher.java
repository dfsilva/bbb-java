...
public class BbbVideoPublisher {
	...
	public void stop() {
		// when the stream is removed from the users module, the client
		// automatically
	...
	public void fireFirstFrame() {
		if (videoConnection != null) {
			videoConnection.publisher.fireNext(
					videoConnection.publisher.channel, 0);
		}
	}
}
